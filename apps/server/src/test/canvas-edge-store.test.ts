...
import { CanvasEdgeRepository } from '../infrastructure/db/repositories/canvas-edge.repository.js'

vi.mock('../infrastructure/db/repositories/canvas-edge.repository.js', () => ({
